                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ __('Add Shipping') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <select  class="form-control show-tick">
                                            <option value="shipping" {{ old('status') == 'active' ? 'selected' : '' }}> Active</option>
                                            <option value="shipping" {{ old('status') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                    </div>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
