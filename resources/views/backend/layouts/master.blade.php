...
<body class="theme-blue">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30"><img src="{{ asset('backend/assets/images/loader.gif') }}" width="48" height="48"
                    alt="Lucid"></div>
            <p>Please wait...</p>
        </div>
    </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="list-unstyled team-info margin-0">
                                                    ...
                                                    <li><img src="{{ asset('backend/images/xs/avatar6.jpg') }}"
                                                            title="Avatar" alt="Avatar"></li>
                                                </ul>
                                            </td>
                                            <td>$ 356</td>
                                            ...
                                            <td>
                                                <ul class="list-unstyled team-info margin-0">
                                                    ...
                                                    <li><img src="{{ asset('backend/assets/images/xs/avatar5.jpg') }}"
                                                            title="Avatar" alt="Avatar"></li>
                                                    <li><img src="{{ asset('backend/assets/images/xs/avatar9.jpg') }}"
                                                            title="Avatar" alt="Avatar"></li>
                                                </ul>
                                            </td>
                                            <td>$ 542</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="list-unstyled team-info margin-0">
                                                    <li><img src="{{ asset('backend/images/xs/avatar3.jpg') }}"
                                                            title="Avatar" alt="Avatar"></li>
